> **Upstream authority notice**
>
> Snapshot of [`docs/protocols/chat-author-provenance.md`](https://github.com/roccoangelella/PiLink/blob/b629c0ee004b7e792125158879c55ee00bd89310/docs/protocols/chat-author-provenance.md)
...
Related protocols:
[`collaboration-role-contracts.md`](https://github.com/roccoangelella/PiLink/blob/b629c0ee004b7e792125158879c55ee00bd89310/docs/protocols/collaboration-role-contracts.md)
at the same pinned upstream commit, and the local authority-marked snapshot of
[`agent-work-loop-transport-continuity.md`](agent-work-loop-transport-continuity.md).

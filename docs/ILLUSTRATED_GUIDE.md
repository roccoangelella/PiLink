...
These sanitized illustrations show the VSPiLink 2.2.0 release flow without
...
![Open ChatGPT Work and connect VSPiLink](assets/guide/02-connect-work.svg)
...
![Review and approve the VSPiLink OAuth request](assets/guide/03-oauth.svg)
...
Write the task in ChatGPT Work with VSPiLink enabled. The VS Code panel shows
